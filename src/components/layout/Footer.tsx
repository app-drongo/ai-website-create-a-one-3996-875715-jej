...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Company',
      links: [
        { name: 'About YourStartup', href: '#about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Live Workshops', href: '/webinars' },
  ...
  const socialLinks = [
    { name: 'Twitter', icon: Twitter, href: 'https://twitter.com/yourstartup' },
    { name: 'Facebook', icon: Facebook, href: 'https://facebook.com/yourstartup' },
    { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/yourstartup' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/yourstartup' },
    { name: 'GitHub', icon: Github, href: 'https://github.com/yourstartup' },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="#hero" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">YourStartup</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Revolutionizing business intelligence with AI-powered analytics and real-time
                insights. Trusted by over 10,000 companies worldwide to make data-driven decisions
                faster.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">support@yourstartup.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm">Weekly AI Insights</h4>
              ...
              <p className="text-xs text-muted-foreground">
                Get exclusive analytics trends and product updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 YourStartup. All rights reserved.</span>
