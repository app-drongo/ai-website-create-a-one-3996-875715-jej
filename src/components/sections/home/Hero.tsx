...
export default function Hero() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Navigate to signup/demo section
  };
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              YourStartup's intelligent coding platform eliminates repetitive tasks, catches bugs
              before deployment, and helps you build production-ready applications in minutes, not
              months.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.8/5 on ProductHunt</span>
              </div>
            </div>
          </div>
                ...
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground/80 mt-1">
                      Watch how we generate full-stack apps
                    </p>
                  </div>
                </div>
              </div>
